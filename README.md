...
本项目 Node.js 版本 16.14.0

### 启动项目

```bash

git clone https://github.com/Evllis/vue2-h5.git
...
- 通过 `yarn stage` 打包测试 , 执行 `staging`
- 通过 `yarn build` 打包正式 , 执行 `production`
